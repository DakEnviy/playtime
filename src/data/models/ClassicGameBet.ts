...
export type ClassicGameBetStatic = AssociableModelStatic<ClassicGameBet>;
...
export const initClassicGameBet = (sequelize: Sequelize): ClassicGameBetStatic => {
    ...
    ClassicGameBet.associate = database => {
        ClassicGameBet.belongsTo(database.User, { as: 'user' });
        ClassicGameBet.belongsTo(database.ClassicGame, { as: 'game' });
    };
